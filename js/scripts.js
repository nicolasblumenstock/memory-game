$(document).ready(function(){
	...
	var cards = [
		...
		'<img src="default/monsters-05.png">',
		'<img src="default/monsters-06.png">',
		'<img src="default/monsters-07.png">',
		'<img src="default/monsters-08.png">',
		'<img src="default/monsters-09.png">',
		'<img src="default/monsters-10.png">',
		'<img src="default/monsters-11.png">',
		'<img src="default/monsters-12.png">',
		'<img src="default/monsters-13.png">',
		'<img src="default/monsters-14.png">',
		'<img src="default/monsters-15.png">',
		'<img src="default/monsters-16.png">'	
	];
	...
	$('.card-holder').click(function(){
		...
		if(cardsUp.length == 2){
			...
			if(card1 == card2){
				...
				console.log(gridSize, matchedCards.length)					
				}
			}else{
				setTimeout(()=>{
					cardsUp.removeClass('flip')},1000)
			}		
		}
